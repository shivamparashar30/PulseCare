...
const styles = StyleSheet.create({
  ...
  iconWrap: { width: 80, height: 80, borderRadius: 24, backgroundColor: '#059669', justifyContent: 'center', alignItems: 'center', marginBottom: 16 },
  ...
  eyeBtn: { padding: 12 },
  loginBtn: { backgroundColor: '#059669', paddingVertical: 14, borderRadius: 12, alignItems: 'center', marginTop: 24 },
