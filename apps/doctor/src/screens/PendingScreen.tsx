  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.desc}>
        {isPending
          ? 'Your verification request is under review. Please wait for Admin approval. You will be notified once your account is verified.'
          : 'Unfortunately, your registration request has been rejected by the admin.'}
      </Text>
