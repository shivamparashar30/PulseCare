    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Diagnostics Portal</Text>
          <Text style={styles.subtitle}>Sign in to manage your center</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  iconWrap: { width: 80, height: 80, borderRadius: 24, backgroundColor: '#7C3AED', justifyContent: 'center', alignItems: 'center', marginBottom: 16 },
  ...
  eyeBtn: { padding: 12 },
  loginBtn: { backgroundColor: '#7C3AED', paddingVertical: 14, borderRadius: 12, alignItems: 'center', marginTop: 24 },
  loginBtnText: { color: '#fff', fontSize: 16, fontWeight: '700' },
  signupLink: { alignItems: 'center', marginTop: 20 },
  signupText: { fontSize: 14, color: '#64748B' },
  signupBold: { color: '#7C3AED', fontWeight: '700' },
});
